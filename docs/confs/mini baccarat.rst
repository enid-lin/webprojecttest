...
3.	You can remove all bets by click ¡¥CLEAR¡¦ button.
...
0 ¡V 5	Draws a card
6 ¡V 7	Stands
8 ¡V 9	Natural hand, no further cards are drawn for Player and Banker

If the Player stands on 6 or 7, then the Banker must hit with a score of 0 ¡V 5, and stand with a score of 6 ¡V 7. If the player does hit then use the table below to determine if the banker hits or stands.
Banker¡¦s rule:
Point value of first two cards	Action
0 ¡V 2	Always draws a card
3	Draw when the Player¡¦s third card is 0 ¡V 7 or 9

4	Draw when the Player¡¦s third card is 2 ¡V 7
5	Draw when the Player¡¦s third card is 4 ¡V 7
6	Draw when the Player¡¦s third card is 6 ¡V 7
7	Always stands
8 ¡V 9	Natural hand, and Player cannot draw
